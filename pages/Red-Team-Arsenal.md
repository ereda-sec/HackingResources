...
* ### Vulnerability Scanners
  ...
  * [joomlavs : A black box, Ruby powered, Joomla vulnerability scanner](https://github.com/rastating/joomlavs){:target="_blank"}
  
  * [Sn1per : Automated pentest framework](https://github.com/1N3/Sn1per){:target="_blank"}
...
* ### Other Recon tools
	...
	*  [SimplyEmail: Email recon Tool](https://github.com/SimplySecurity/SimplyEmail){:target="_blank"}
...
* ### Network Exploitation Tools
	...
	*  [CrackMapExec : A swiss army knife for pentesting networks](https://github.com/byt3bl33d3r/CrackMapExec){:target="_blank"}
...
* ### Powershell Tools
	...
	*  [PowerCat : A PowerShell TCP/IP swiss army knife that works with Netcat & Ncat](https://github.com/secabstraction/PowerCat){:target="_blank"}
...
* ### Web Penetration Testing tools
	...
	* #### Exploitation
		...
		* XXE
			...
			* [oxml_xxe : A tool for embedding XXE/XML exploits into different filetypes](https://github.com/BuffaloWill/oxml_xxe){:target="_blank"}			
		...
		* Authorization testing
			* [Token Reverser : Word list generator to crack security tokens](https://github.com/dariusztytko/token-reverser){:target="_blank"}
		
		* Information Disclosure
			* [Password Search: Reconnaissance and auditing tool that search for passwords within code repositories](https://github.com/jaegerindustries/password_search){:target="_blank"}

		* Other tools
			* [gethead: HTTP Header Analysis Vulnerability Tool](https://httphacker.github.io/gethead/){:target="_blank"}

			
* ### AWS Testing Tools		

	*  [AWS S3 Bucket Name Generator : A simple tool for generating permutations, alterations and mutations of AWS S3 Buckets Names](https://github.com/m4ll0k/AWSGen.py){:target="_blank"}
...
* ### Bypass Restrictions
	...
	*  [icmptunnel : Transparently tunnel your IP traffic through ICMP echo and reply packets](https://github.com/DhavalKapil/icmptunnel){:target="_blank"}
